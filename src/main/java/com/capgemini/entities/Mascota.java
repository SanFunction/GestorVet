...
import com.capgemini.controller.EntityIdResolver;
...
@NoArgsConstructor
@Table(name="mascota")
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class, property = "id", scope=Mascota.class, resolver = EntityIdResolver.class)
